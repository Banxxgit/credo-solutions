          ...
          {services.map((service, index) => (
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white shadow-soft group-hover:bg-primary rounded-xl sm:rounded-2xl flex items-center justify-center transition-colors duration-300 flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-dark-50 text-sm mb-5 leading-relaxed">
                    {service.description}
                  </p>

                  <div className="flex flex-col sm:grid sm:grid-cols-2 gap-2.5">
                    {service.features.map((feature, idx) => (
                      <span key={idx} className="flex items-center gap-2.5 text-sm text-dark-50">
